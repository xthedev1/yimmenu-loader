...
{
    WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, ("YimLoader"), NULL };
    wc.hbrBackground = (HBRUSH)0;
    RegisterClassEx(&wc);
    main_hwnd = CreateWindowEx(NULL, wc.lpszClassName, ("YimLoader"), WS_POPUP, (GetSystemMetrics(SM_CXSCREEN) / 2) - (WINDOW_W / 2), (GetSystemMetrics(SM_CYSCREEN) / 2) - (WINDOW_H / 2), WINDOW_W, WINDOW_H, 0, 0, 0, 0);
    ...
    while (msg.message != WM_QUIT)
    {
...

        {
            ...
            ImGui::Begin(("YimLoader"), &Helper::g_Running, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysUseWindowPadding | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoBringToFrontOnFocus | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse);
            {
                static POINT mouse;
                static RECT rc = { 0 };
